...
smallfont=pygame.font.Font("C:\Windows\Fonts\Arial",32)
medfont=pygame.font.Font("C:\Windows\Fonts\Arial",50)
largefont=pygame.font.Font("C:\Windows\Fonts\Arial",80)
